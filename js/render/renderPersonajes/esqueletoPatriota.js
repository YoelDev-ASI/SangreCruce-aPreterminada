/**
 * esqueletoPatriota.js
 * 
 * Renderizador de esqueleto articulado (Fase Stickman Animado) para el bando Patriota.
 ...
 */
export function dibujarEsqueletoPatriota(ctx, personaje, colorCuerpo, callbackArma) {
    ctx.save();
    
    // Origen de coordenadas: base del personaje (pies)
    ctx.translate(personaje.x, personaje.y);
    
    // Los patriotas avanzan hacia la derecha por defecto (esPatriota = true, dir = 1)
    const dir = 1;
