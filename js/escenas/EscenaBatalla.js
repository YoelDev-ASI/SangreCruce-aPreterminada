...
export class EscenaBatalla {
    ...
    constructor(anchoLogico, altoLogico, motor, datosMision) {
        ...
        // Iniciar música
        sonidos.playMusica('assets/audio/marcha_batalla.mp3');
    ...
    update(dt) {
        ...
        if (this.hud) {
            ...
            this.hud.update(this.recursos.getOro('patriota'), popPatriota + this.colaEntrenamiento.length);
        }
    ...
    draw(ctx) {
        ...
        ctx.fillText(this.datosMision.nombre.toUpperCase(), 40, this.altoLogico - 55);

        ctx.fillStyle = '#c5a059';
        ctx.font = '13px "Outfit", sans-serif';
        ctx.fillText(`Fase 8 - Ampliación: Entrenamiento 5s | Límite Pop: 50 | Minas 2/Mina Máx | Defensores Estatua`, 40, this.altoLogico - 30);
