...
export class EscenaBatalla {
    ...
    constructor(anchoLogico, altoLogico, motor, datosMision) {
        ...
        this.transitandoACreditos = false;
        this.mostrarFps = 0;
    ...
    update(dt) {
        ...
        if (this.pantallaFinal || this.transitandoACreditos) {
        ...
        if (this.baseRealista.estado === 'DESTROYED') {
            if (this.pantallaFinal === 'VICTORIA' || this.transitandoACreditos) return;
            ...
            if (this.datosMision.nivel === 5) {
                this.transitandoACreditos = true;
