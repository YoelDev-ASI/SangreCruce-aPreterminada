...
export class EscenaPrincipal {
    ...
    draw(ctx) {
        ...
        if (!this.mostrarAjustes && !this.mostrarCreditos) {
            ...
            ctx.fillText("UTEPSA - DESARROLLO DE VIDEOJUEGOS", this.anchoLogico / 2, this.altoLogico - 40);
        }
    ...
    drawModalCreditos(ctx) {
        ...
        ctx.fillText("SANGRE CRUCEÑA - REVOLUCIÓN CRUCEÑA", this.anchoLogico / 2, y + 90);
        ...
        ctx.fillStyle = '#ffffff';
        ctx.font = 'bold 15px "Outfit", sans-serif';
        ctx.fillText("Desarrollo de Videojuegos", this.anchoLogico / 2, y + 210);
